...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-900 text-white pt-10 pb-24 md:pb-6">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><Link to="/returns" className="hover:text-[#f5ebd0]">Replacement Policy</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="text-lg font-semibold mb-4">Stay Connected</h3>
            <div className="flex space-x-4">
                           <a href="https://www.instagram.com/uc_signgalaxy?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="bg-gray-800 p-2 rounded-full hover:bg-[#f5ebd0] transition-colors group">
