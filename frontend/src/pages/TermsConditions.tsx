        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
            ...
            <div className="prose prose-purple max-w-none text-gray-700 space-y-6">
                <section>
                    ...
                    <p>Welcome to Printique. By accessing our website and placing an order, you agree to be bound by these Terms and Conditions.</p>
                </section>
                ...
                <section>
                    ...
                    <p>All content on this website, including images, designs, and text, is the property of Printique and is protected by copyright laws.</p>
                </section>
