...
export const RecentlyViewedDetails: React.FC = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto py-8 px-4 border-t border-gray-100 relative group/section mt-8">
                        ...
                        <div key={productId} className="min-w-[160px] md:min-w-[220px] snap-start relative group">
                            <Link to={`/product/${productId}`} onClick={() => window.scrollTo(0, 0)} className="bg-white rounded-lg border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300 flex flex-col h-full">
                                <div className="relative aspect-square bg-white overflow-hidden">
                                    ...
                                    {product.discount && <div className="absolute top-0 left-0 bg-red-600 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-br-lg shadow-sm z-10">{product.discount}% OFF</div>}
                                </div>
